...
CREATE TABLE licitacao_fornecedor (
...
CREATE INDEX idx_socio_cpf ON socio (cnpj_cpf_socio);
...
CREATE INDEX idx_fornecedor_socio_socio ON fornecedor_socio (socio_id);
...
CREATE INDEX idx_contrato_cnpj_orgao ON licitacao_contrato (cnpj_orgao);
CREATE INDEX idx_contrato_uf ON licitacao_contrato (ug_uf_sigla);
CREATE INDEX idx_contrato_codigo_ibge ON licitacao_contrato (ug_codigo_ibge);
CREATE INDEX idx_contrato_data_publicacao ON licitacao_contrato (data_publicacao_pncp);
CREATE INDEX idx_contrato_ano ON licitacao_contrato (ano_contrato);
CREATE INDEX idx_contrato_uf_ibge ON licitacao_contrato (ug_uf_sigla, ug_codigo_ibge);
CREATE INDEX idx_contrato_mes_uf ON licitacao_contrato (date_trunc('month', data_publicacao_pncp), ug_uf_sigla);
CREATE INDEX idx_contrato_mes_ibge ON licitacao_contrato (date_trunc('month', data_publicacao_pncp), ug_codigo_ibge);
CREATE INDEX idx_contrato_mes_orgao ON licitacao_contrato (date_trunc('month', data_publicacao_pncp), cnpj_orgao);

CREATE TABLE licitacao_busca_controle (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE INDEX idx_busca_controle_data ON licitacao_busca_controle (ultima_atualizacao);
